...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-[80] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg sm:bottom-8 sm:right-8 sm:h-14 sm:w-14"
      style={{
